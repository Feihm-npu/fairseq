...
class FeedForwardNetwork(nn.Module):
    ...
    """
    def __init__(self, args, embed_dim, ffn_dim, dropout_module=None, q=False):
        super().__init__()
        ...
        self.q = getattr(args, "q_int8", q)
        # self.
        # print("To quantize",self.q)
        # logger.info(f'To quantize: {self.q}')
