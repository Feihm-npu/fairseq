...
def cli_main(
    ...
    SAVE_DIR = "/work1/amd/hongmfei/moespace/SPEED-main/fairseq/checkpoints-mixtralv2"
    HF_MODEL_NAME = "mistralai/Mixtral-8x7B-v0.1"
    NUM_EXPERTS = 4
    TOKENS_PER_SAMPLE = 2048

    args.task = "mixtral_language_modeling"
    args.hf_model_name = HF_MODEL_NAME
    args.data = DATA_PATH
    args.tokens_per_sample = TOKENS_PER_SAMPLE
    args.arch = "mixtral_lm_arch"
    args.share_decoder_input_output_embed = True
    args.decoder_layers = 2
    args.decoder_embed_dim = 4096
    args.decoder_ffn_embed_dim = 14336
    args.decoder_attention_heads = 64
    args.moe_expert_count = NUM_EXPERTS
    args.moe_freq = 1
    args.moe_gating_use_fp32 = True
    args.moe_second_expert_policy = "all"
    args.moe_normalize_expert_grad = "sqrt_world_size"
    args.moe_eval_capacity_token_fraction = -1.0
    args.max_sentences_valid = 1
    args.num_workers_valid = 0
    args.criterion = "moe_cross_entropy"
    args.moe_gate_loss_wt = 0.01
    args.moe_gate_loss_combine_method = "sum"
    args.optimizer = "adam"
    args.fp16_adam_stats = True
    args.adam_betas = "(0.9,0.98)"
    args.clip_norm = 0.0
    args.lr = [0.0005]  # lr是列表
    args.warmup_updates = 750
    args.dropout = 0.1
    ...
    args.restore_file = os.path.join(SAVE_DIR, "checkpoint_last.pt")
    args.ddp_backend = "fully_sharded"
    args.memory_efficient_fp16 = True
